    ...
    const [userData, setUserData] = useState(null);
      ...
      const fetchPosts = async () => {
        try{
          ...
          //Display posts created only by this logged in user or the particular user whose profile has been viewed.
          await firestore() 
          .collection('posts')
        ...
        <SafeAreaView style = {{flex:1,backgroundColor:'#fff'}}>
            ...
            >
                <Image style = {styles.userImg} 
                          ...
                          />
                <Text style = {styles.userName}>{userData ? userData.fname:'No Details'} {userData ? userData.lname:''}</Text>
